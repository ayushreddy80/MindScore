...
class PredictionResponse(BaseModel):
    predicted_mental_heath_score: float


@app.get('/')
def greet():
    return {'message': 'Welcome to the Mental Health Prediction'}
...
def predict(data: StudentData):
    ...
    return PredictionResponse(predicted_mental_heath_score=round(float(prediction), 2))
